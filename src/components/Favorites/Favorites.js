...
const Favorites = () => {
    ...
    return (
        <div className="favorites">
            ...
            {
                response.id? <div onClick={handleLink}>List</div>: <button onClick={handleSave} type="button" disabled={input?false:true} className="favorites__save">{input ? "YADDA SAXLA" : "LISTE AD VER"}</button>
            }
